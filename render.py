...
def processCommandLine():
    ...
    parser.add_argument("-t", "--tmp", metavar="TMP", dest="tmp", type=str,
                        default=".", required=False, help="temporal directory")
...
def main():
    ...
    with open(args.tmp+"/resume.md", "w") as f:
        f.write(mdTemplate.render(**resume).decode('utf8'))
    ...
    with open(args.tmp+"/resume.hugo", "w") as f:
        f.write(texTemplate.render(**resume).decode('utf8'))
